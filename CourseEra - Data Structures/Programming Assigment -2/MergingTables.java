...
public class MergingTables {
    ...
    int maximumNumberOfRows = -1;
        ...
        void merge(Table destn, Table srce) {
            Table realDestination = destn.getParent();
            Table realSource = srce.getParent();
    ...
    public void run() {
        ...
        for (int i = 0; i < m; i++) {
            int destn = reader.nextInt() - 1;
            int srce = reader.nextInt() - 1;
            merge(tables[destn], tables[srce]);
            writer.printf("%d\n", maximumNumberOfRows);
        }
    }
    ...
    static class InputReader {
        ...
        public InputReader(InputStream stream) throws FileNotFoundException {
        	//File file=new File("D:\\CourseEra\\Data Structues & Algorithm\\Programming Assigment -2\\Programming-Assignment-2\\merging_tables\\tests\\116.txt");
